...
function Catch2({error}) {
  ...
  return (
    <div className="catch-container">
      ...
      <div id="chatSimulation" ref={chatRef} className={`relative ${isChatStarted ? '' : 'blurred'}`}>
        {!isChatStarted && (
        ...
        <div className="fake-input-bar">
          <input type="text" placeholder="Type your message..." className="fake-input" disabled />
      ...
      <div className='buttonWrapper'>
        {!isChatStarted && (
          <button
            className="overlay-button bg-transparent text-white font-bold py-2 px-8 border border-white rounded"
            onClick={startChat}
          >
            Start Chat
          </button>
